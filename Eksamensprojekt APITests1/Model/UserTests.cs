...
namespace Eksamensprojekt_APITests1.Model
{
    [TestClass()]
    public class UserTests
    {
        ...
        private User useridnulltest = new User { Id = 0, Address = "Hello", City = "Hello", Name = "Hello", Password = "Hello", PhoneNumber = "12345678", TrashCanId = 1, UserName = "Hello ", ZipCode = 1234 };
